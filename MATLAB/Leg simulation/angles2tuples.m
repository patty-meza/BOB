function angle_tuples = angles2tuples(angles_cell1, angles_cell2)
    ...
    for i = 1:length(angles_cell1)
        angle_tuples{i} = [
            ['[(', num2str(zero), ', 11), (' num2str(zero), ', 12), '],...
            ['(', num2str(deg2motor(angles_cell1{i}{1})), ', 13), (' num2str(deg2motor(angles_cell1{i}{2})), ', 14), '],...
            ['(', num2str(zero), ', 21), (' num2str(zero), ', 22), '],...
            ['(', num2str(deg2motor(angles_cell2{i}{1})), ', 23), (' num2str(deg2motor(angles_cell2{i}{2})), ', 24)]'],...
        ];
